...
public class Main {
    public static void main(String[] args) {
       ...
       gestionDepartements.displayDepartement();
        ...
        Employe emp1 = new Employe(1, "Ali", "Hassen", "Informatique", 5);
        Employe emp2 = new Employe(2, "Ahmed", "Slim", "RH", 3);
        ...
        gestionAffectations.ajouterEmployeDepartement(emp1, dep2);
